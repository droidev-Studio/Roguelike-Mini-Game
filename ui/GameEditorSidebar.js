const pngModules = import.meta.glob([
    '../assets/Visual Style/**/*.png',
    '../assets/Game Art/**/*.png',
    '../assets/Audio & Feel/**/*.png',
...
const MEDIA_STRUCTURE = [
    {
        ...
        categories: [
            ...
            { id: 'ui', label: 'UI', sections: ['UI Skins', 'UI Skin Library'], path: 'assets/Visual Style/ui' },
        ],
    },
    {
        id: 'art',
        ...
        categories: [
            ...
            { id: 'attacks', label: 'Attacks', sections: ['Weapon Attacks'], path: 'assets/Game Art/weapons/attacks' },
...
const CSS_UI_SKINS = new Set([
    'Visual Style/ui/asset_ui_menu_panel.png',
    'Visual Style/ui/asset_ui_button_frame.png',
    'Visual Style/ui/asset_ui_upgrade_card_frame.png',
    'Visual Style/ui/asset_ui_dialog_panel.png',
    'Visual Style/ui/asset_ui_hud_bar_frame.png',
    'Visual Style/ui/asset_ui_status_panel.png',
    'Visual Style/ui/asset_ui_warning_banner.png',
    'Visual Style/ui/asset_ui_pause_panel.png',
]);
    ...
    for (const [uiId, entry] of Object.entries(manifest.ui || {})) {
        addAsset(assets, refs, {
            ...
            binding: CSS_UI_SKINS.has(entry.src)
                ? 'Canvas drawArtUiTexture and ui/game-ui.css'
...
function classifyUnboundAsset(src) {
    ...
    if (logical.startsWith('weapons/attacks/')) {
        return {
            tab: 'art',
            section: 'Weapon Attacks',
            role: 'unbound attack candidate',
            binding: 'Not referenced by manifest; likely alternate or staging texture',
        };
    }
...
function renderAssetTile(asset) {
    return `
        <article class="media-thumb-card" title="${escapeHtml(asset.src)}">
            ...
            <button class="media-thumb-menu" type="button" aria-label="Asset menu">&#8942;</button>
        </article>
    `;
}
